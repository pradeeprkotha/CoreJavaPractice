...
public class StockPriceDataFetcher {
    public static void main(String[] args) {
        ...
        anyOfResults.thenRun(()->{
            Double weather1 = api1Results.join();
            Double weather2 = api2Results.join();
    ...
    public CompletableFuture<Double> fetchStockPriceFromApi2(String symbol) {
        return CompletableFuture.supplyAsync(() -> {
            // Simulate a network delay
            simulateDelay(2000); // Simulate a delay of 3 seconds
            return 195.0; // Simulated stock price from API 2
        });
    }
